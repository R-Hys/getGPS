...
$(App_Name): App/Enclave_u.o App/Seal_u.o $(App_Cpp_Objects)
...
$(Signed_Seal_Enclave_Name): $(Seal_Enclave_Name)
	...
	@echo "SIGN =>  $@"
	@rm $(Seal_Enclave_Name)
	@echo "RM   =>  $(Seal_Enclave_Name)"
...
$(Signed_Enclave_Name): $(Enclave_Name)
	...
	@echo "SIGN =>  $@"
ifneq ($(SGX_PCL), 0)
	@rm $(Enclave_Name) $(Encrypted_Enclave_Name)
else
	@rm $(Enclave_Name)
endif
	@echo "RM   =>  $(Seal_Enclave_Name) and $(Encrypted_Enclave_Name)"


.PHONY: clean

clean:
	@rm -f .config_* $(App_Name) $(Enclave_Name) $(Signed_Enclave_Name) $(App_Cpp_Objects) App/Enclave_u.* $(Enclave_Cpp_Objects) Enclave/Enclave_t.*  $(Encrypted_Enclave_Name) $(Seal_Enclave_Name) $(Signed_Seal_Enclave_Name) App/Seal_u.* $(Seal_Enclave_Cpp_Objects) Seal/Seal_t.* sealed_key.bin encgps.dat
